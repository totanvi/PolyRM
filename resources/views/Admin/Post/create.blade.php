...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				<strong>Đăng bài viết mới</strong>
			</li>
		</ol>
	</div>
	<div class="col-lg-2">
				...
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="description" placeholder="Mô tả ngắn"></textarea>
							</div>
						</div>
					</div>
					<div class="row" style="margin-bottom: 30px;">
						<div class="col-md-12">
							...
							<textarea class="form-control" id="my-editor"></textarea>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="col-xs-12 col-sm-12 col-md-12">
								<h4 class="form--title">Hình ảnh đại diện cho bài viết</h4>
							</div>
					...
					<button class="btn btn-primary save">Đăng bài viết</button>
				</div>
			</div>
		</div>
	</div>
