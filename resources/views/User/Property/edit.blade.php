...
@section('content')
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form class="mb-0" id="propertyForm" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="property_title" id="property_title" value="{{ $getProperty->property_title }}">
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-12">
									<div class="form-group">
										<label for="property-description">Mô tả</label> <span class="error property_description"></span>
										<textarea class="form-control" id="my-editor" name="property_description" rows="2">
								...
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="property_price" id="property_price" value="{{ $getProperty->property_price }}">
									</div>
								</div>
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										<label for="property_phone">Số điện thoại</label> <span class="error property_phone"></span>
										<input type="text" class="form-control" name="property_phone" id="property_phone" value="{{ $getProperty->property_phone }}">
									</div>
								</div>
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										<label for="property_bedroom">Phòng ngủ</label> <span class="error property_bedroom"></span>
										<input type="text" class="form-control" name="property_bedroom" id="property_bedroom" value="{{ $getProperty->property_bedroom }}">
									</div>
								</div>
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										<label for="property_bathroom">Phòng tắm</label> <span class="error property_bathroom"></span>
										<input type="text" class="form-control" name="property_bathroom" id="property_bathroom" value="{{ $getProperty->property_bathroom }}">
									</div>
								</div>
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										<label for="property_area">Diện tích</label> <span class="error property_area"></span>
										<input type="text" class="form-control" name="property_area" id="property_area" value="{{ $getProperty->property_area }}">
									</div>
								</div>
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<div class="select--box">
											...
											<select class="city" name="select-location" id="property_city">
												...
												<option value="{{ $citys->city_name }}" @if($getProperty->city->city_name == $citys->city_name) selected @endif>{{ $citys->city_name }}</option>
												@endforeach
											</select>
										</div>
									</div>
								...
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="property_location" id="property_location" value="{{ $getProperty->property_location }}">
									</div>
								</div>
							</div>
						</div>
						<div class="form-box">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12">
									...
									@foreach ($getProperty->image as $item)
										<div class="col-md-3 image-property">
											<span class="fa fa-times-circle image-x"></span>
											<img src="{{ asset('/upload/'. $item->image_path) }}" class="img-responsive" image-id="{{ $item->image_id }}">
										</div>
									@endforeach
								</div>
						...
						<input type="submit" value="Sửa tin" name="submit" id="editProperty" class="btn btn--primary">
					</form>
				</div>
			</div>
		</div>
	...
	@section('scripts')
	<script>
		let district_edit = "{{ $getProperty->district_id}}";
		let id_property = "{{ $getProperty->property_id }}";
	</script>
	...
	<script src="{{ asset('js/ajax/EditProperty.js') }}"></script>
